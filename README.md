...
Basically Taskscheduling is a common way for Malware Acteurs to achieve persistence by utilizing it. This persistence via Taskscheduler is achieved by i think 2 mechanism im not 100% sure. But i know:<br>
It gets saved in a Registry Tree or lets say new Tasks get added there, and there is a xml file which also holds the Tasks scheduled. By Monitoring those 2 Factors we can almost say certain there is no Taskscheduling without Kernel Tricks <br>
